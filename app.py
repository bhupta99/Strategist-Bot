    ...
    if 'message' in data:
        ...
        if text == '/start':
            ...
            reply = (
                ...
                "🎯 Sample Stock: Tata Steel — Short ₹145.20 | SL ₹148.50 | Target ₹140.10\n"
            ...
            reply = (
                ...
                "- Mercury: Retrograde ingress active\n"
                "- Mars: Combust under Sun\n"
                "⚠️ Avoid intraday F&O trades till lunar ingress completes"
            )

        elif text == '/codexwatch':
            reply = (
                "🌀 CodexABCD Harmonic Insights:\n"
                "- Nifty: Bearish Shark PRZ near 23,637\n"
                "- RSI Divergence forming below 50EMA\n"
                "- Watch for sync zone exhaustion post 12:45pm IST"
            )

        elif text == '/nextalert':
            reply = (
                "📅 Next Astro Trigger Forecast:\n"
                "🔭 Rule #14: Venus longitude cross — Aug 9, 2025\n"
                "📐 Gann Emblem Shift: July 11 pressure date\n"
                "🌌 Combust Mars clears by July 13\n"
                "🕰️ Expected sector impact: Pharma, Banks, FMCG"
            )
